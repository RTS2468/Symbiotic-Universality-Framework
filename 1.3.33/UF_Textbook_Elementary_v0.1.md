# Universality Framework — Elementary Textbook (v0.1 Alpha)

**Date:** 2025-08-06  
**Audience:** Elementary (Grades 3–5)  
**Tone/Style:** Concrete, playful, visual  
...
---
## Preface
This textbook introduces the Universality Framework (UF) at a elementary level. You’ll learn how we describe **choices**, **consequences**, and **fairness** using simple math and clear steps. Pictures and activities help connect ideas to real life.
...
4. Doing No Harm
5. Feelings and Choices
6. Virtues & Sins (Actions Only)
7. Helping Others Together
8. Project: Our Class Code of Kindness
...
**Story/Hook:** A short scenario tailored to elementary learners.  
